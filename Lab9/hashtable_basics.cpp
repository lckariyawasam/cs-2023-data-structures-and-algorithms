...
struct HashTable{
	...
	//add your code below
        ...
        // Iterate each character of the user_name and add its ascii values
    ...
    // If the slot is empty, add user password in the index of the hash
    if (empty) {
    ...
    if (!empty) {
        ...
        cout << "Collision occured. Username not added" << endl;
    }
